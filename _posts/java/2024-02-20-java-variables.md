...
| 값의 분류         | 기본타입(8가지)                                                          |
| ----------------- | ------------------------------------------------------------------------ |
| 정수(n)           | byte(1byte), char(2), short(2), int(4), long(8, 숫자뒤에 `L`적어줘야 함) |
...
| %6d      |        | 6자리 정수                                      | 123               |
| %-6d     |        | 6자리 정수                                      |                   |
| %06d     |        | 왼쪽 빈자리 공백 6자리 정수                     | \_ \_ \_123       |
| %60d     |        | 오른쪽 빈자리 공백 6자리 정수                   | 123\_ \_ \_       |
| %06d     |        | 왼쪽 빈자리 0채운 6자리 정수                    | 000123            |
| %10.2f   | 실수   |                                                 |
| %-10.2f  |        |                                                 |                   |
| %010.2f  |        | 정수 7자리+소수점+소수2자리, 왼쪽 빈자리 공백   | \_ \_ \_ \_123.45 |
|          |        | 정수 7자리+소수점+소수2자리, 오른쪽 빈자리 공백 | 123.45\_ \_ \_ \_ |
|          |        | 정수 7자리+소수점+소수2자리, 왼쪽 빈자리 0채움  | 0000123.45        |
| %s       | abc    | 문자열                                          | abc               |
| %6s      |        |                                                 |                   |
| %-6s     |        | 6자리 문자열, 왼쪽 빈자리 공백                  | \_ \_ \_ abc      |
|          |        | 6자리 문자열, 오른쪽 빈자리 공백                | abc \_ \_ \_      |
| \t       |        | 탭(tab)                                         |                   |
| \n       |        | 줄바꿈                                          |                   |
| %%       |        | 문자열                                          |                   |
