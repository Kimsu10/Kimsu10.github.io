...
commit을 남긴후 `git log`를 입력하여 커밋이 잘 올라갔는지 확인하자.
...
![](https://velog.velcdn.com/images/kimsu10/post/11dfac00-f69d-4592-8a6e-a730818ba505/image.png)

`compare & pull request`를 누른뒤 어떤 작업을 했는지 설명해주면
