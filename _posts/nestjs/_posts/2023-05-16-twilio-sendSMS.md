...
설마 핸드폰 번호 인증하기에서 첫번째 구간이였다.

일단 문자 인증서비스를 어디를 이용할까 찾아보았다.
...
저렴한 곳 중 독일이랑 미국을 고민하다 미국번호로 선택하였다.(1.15달러였나 1.5달러였나)
...
자체적으로 제공하는 서비스를 사용하니 인증코드의 길이도 브라우저에서 자유롭게 정할 수 있어서 편리했다.
